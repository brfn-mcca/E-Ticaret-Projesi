...
{
    public partial class frmAraçLislete : Form
    {
        Araç_Kiralama arackiralama = new Araç_Kiralama();
        public frmAraçLislete()
        {
            InitializeComponent();
        }
        ...
        private void frmAraçLislete_Load(object sender, EventArgs e)
        {
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            string cümle="delete from araç where plaka='"+satir.Cells["plaka"].Value.ToString()+"'";
            SqlCommand komut2 = new SqlCommand();
            arackiralama.ekle_sil_güncelle(komut2, cümle);
            YenileAraçlarListesi();
            pictureBox2.ImageLocation = " ";
